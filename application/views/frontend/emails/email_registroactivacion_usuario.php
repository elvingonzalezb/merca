...
<tr>
	<td width="600" align="center" style="background:#fff;">
		...
		<tr>
			<td height="20"></td>
			<td>
				<p>Para poder empezar a usar nuestros servicios debe activar su cuenta. Para ello haga click en el siguiente link:<br><br>
					<a href="<?php echo base_url().'registrate/activacion/'.$timestamp; ?>" class="boton">ACTIVAR CUENTA</a></p>
			</td>
			<td></td>
		</tr>
		<tr>
