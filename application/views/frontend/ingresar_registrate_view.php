        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 create-new-account">
          ...
          <form class="register-form outer-top-xs" action="ingresar_registrate/validarLogin" method="post" id="ingresarform" name="ingresarform">
           ...
           <div class="form-group">
            ...
            <p class="text-right"><input type="submit" class="btn-upper btn btn-primary checkout-page-button bg" value="Ingresar"></p>
       ...
       <!-- create a new account -->
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 create-new-account">
          ...
          <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
            ...
            ?>  
          <form class="register-form outer-top-xs" action="ingresar_registrate/enviar" method="post" id="registerform" name="registerform">
