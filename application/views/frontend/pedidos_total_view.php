                  ...
                  <tbody>
                    <tr>
                       <td class="romove-item"><a href="javascript:deleteItem('<?=$item['item_carroID']?>')" title="cancel" class="icon"><i class="fa fa-trash-o"></i></a></td>
                        ...
                        <td class="">
                         <input class="sinborde" type="text" name="item[<?=$key?>][item_precio]" size="4" value="<?=$item['item_precio']?>" id="precio_<?=$key?>">
                        </td>

                        <td class="">
                         <input class="sinborde" type="text" name="item[<?=$key?>][item_subtotal]" size="4" value="<?=$item['item_subtotal']?>" id="subtotal_<?=$key?>">
                        </td>
              ...
              <?php endforeach?>
                      <!--TOTAL-->
                        <tr>
                          ...
                          <th class="tbltotal"><?php echo "$". $total;?></th>
                        </tr>
          </table>
        </div>
      </div>
