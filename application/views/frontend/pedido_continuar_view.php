          ...
          echo'<table class="table table-bordered">';
                  echo'<thead>';
                    echo'<tr>';
                      ...
                      //echo'<th class="cart-edit item">Descripcion</th>';
                    ...
                    echo'<tbody>';
                      echo'<tr>';
                        ...
                        echo'<td class="cart-product-sub-total">';
                          echo'<h4 class="cart-product-description">';
                            echo'<a href="index.php?page=detail"> '.$item['item_nom_producto'].'</a>';
                          echo'</h4>';
                         
                           echo'<div class="cart-product-info">';
                            echo'<span class="product-color">'.$item['item_codigo'].'</span>';
                          echo'</div>';
                        echo'</td>';

                       // echo'<td style="width:350px" class="cart-product-coment">';
                         // echo'<span class="product-color">'.$item['item_resumen'].'</span>';
                        //echo'</td>';
