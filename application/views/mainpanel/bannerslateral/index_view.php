            ...
            <table class="table table-striped table-bordered bootstrap-datatable datatable">
                ...
                <?php
...

                    {
                        ...
                        $pic = '<img src="files/bannerlateral/'.$banner->imagen.'" width="300" height="300" />';
                        ...
                        echo '<a class="btn btn-info" href="mainpanel/bannerslateral/edit/'.$banner->id_banner.'"><i class="icon-edit icon-white"></i>  Editar</a> ';

                        echo '<a class="btn btn-danger" href="javascript:deleteBannerLateral(\''.$banner->id_banner.'\')"><i class="icon-trash icon-white"></i>Borrar</a>';
