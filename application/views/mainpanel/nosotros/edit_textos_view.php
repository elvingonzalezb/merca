...
<div class="row-fluid sortable">
    <div class="box span12">
        ...
        <div class="box-content">
            <form class="form-horizontal" action="mainpanel/nosotros/actualizarTexto/<?php echo $generales->seccion;?>" method="post" enctype="multipart/form-data" onsubmit="return validar_articulo()">
                <fieldset>
                    <legend>Ingrese la información a modificar</legend>
                    <?php 
                       if($this->session->userdata('success'))
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="span6"><img src="files/nosotros/<?php echo $generales->imagen; ?>" width="300" /></div>
                            </div>
                        </div>
                        <div class="control-group">
                            <div class="controls">
                        ...
                        <div class="control-group">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <label class="radio">
                                        <input type="hidden" name="state" id="estado1" value="2">
                                    </label>
                        ...
                        <div class="form-actions">
                         ...
                         <a class="btn btn-danger" href="mainpanel/nosotros/listado">VOLVER AL LISTADO</a>
                        </div>
                </fieldset>
            </form>
        </div>
