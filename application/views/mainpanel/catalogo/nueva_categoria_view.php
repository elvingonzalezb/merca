...
<div class="row-fluid sortable">
    <div class="box span12">
        ...
        <div class="box-content">
            <form class="form-horizontal" action="mainpanel/catalogo/grabarCategoria" method="post" enctype="multipart/form-data" onsubmit="return validaCategoria()">
                <fieldset>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls span10">
                            <input type="text" class="span6 typeahead" id="nom_cat" name="nom_cat" value="" onkeyup="url_amigable('nom_cat', 'url', 'title');" >
                        </div>
                    </div>
                    <div class="control-group">
